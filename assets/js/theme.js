...
document.querySelectorAll('.detail-btn').forEach(function (e) {
  e.onclick = function () {
    console.log(e.getAttribute('detail'));
    document.querySelector('.detail-content').classList.add('d-none');
    document.querySelector('.detail-content img').setAttribute('src', e.getAttribute('detail'));
    document.querySelector('.detail-content').classList.remove('d-none');
    setTimeout(function () {
      var anchor = document.querySelector('.detail-content').offsetTop + document.querySelector('.navbar').offsetHeight;
      window.scrollTo({
        top: anchor,
        left: 0,
        behavior: 'smooth'
...
window.addEventListener('scroll', function () {
  if (window.scrollY > 600) {
    document.querySelector('.backToTop').classList.remove('d-none');
  } else {
    document.querySelector('.backToTop').classList.add('d-none');
  }
});
/* -------------------------------------------------------------------------- */
